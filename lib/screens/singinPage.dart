           ...
           children: [
            Expanded(
              ...
              child: Container(
                ...
                child: RiveAnimation.asset("lib/assets/animasyon/animasyon.riv",fit: BoxFit.cover,),
              ),
            ),
            Expanded(
              flex: 11,
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  if (formKey.currentState!.validate()) {
                                    ...
                                    //auth işlemi
                                    _authService.creatPerson(
                                        adi.text.trim().toLowerCase(),
                                        mail.text.trim().toLowerCase(),
                                        sifre.text.trim(),
                                        secilenCinsiyet,
                                        secilenKilo,
                                        secilenBoy);
